        ...
        <div class="row">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="email*"
                            value="<?php if(isset($cust_id)) echo $cust_id; ?>" name="email" required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" placeholder="Message*" name="msgtxt" rows="3" col="10"
                            required /></textarea />
                    </div>
                    <div class="form-group">
            ...
            <div class="col-sm-4" style="padding:30px;">
                <div class="form-group">
                    ...
                    <i class="fa fa-home" aria-hidden="true"></i>&nbsp; 23-A ,North-East Campus,Kingsway,London Zip
                    Code-2000411<br>(24*7 Days)
